                            ...
                            <div id="lung_buycar">
                                ...
                                <div class="lung_buycar--content clear">
                                    <div data-num="1" data-price="0.01" data-goodsid="121112" data-type="90"
                                        ...
                                        <div class="order__content"><img src=""><span
        ...
        <div class="page__title--menu">
            ...
            <section class="login--input">
                <div class="login--wap text-left"><h3 class="login--title">会员登录</h3>
                    <form id="jsForm" class="bl-form bl-formhor" method="post" action="{{url('ad/loginuser')}}">
                        {{csrf_field()}}
                        <ul>
                            ...
                            <li class="bl-form-group"><span class="icon-lock"></span><input type="password" value=""
                                                                                            name="pwd"
                                                                                            color="color" required
                                                                                            minlength="6"
                                                                                            data-msg-minlength="*"
                            ...
                            <li class="bl-form-group code"><input type="text" placeholder="验证码" value="" name="code"
                                                                  color="color"
                                                                  required minlength="4" data-msg-minlength="*"
                                                                  maxlength="4"
                                                                  data-msg-mobile="*" class="pwd"><img
                                        src="{{url('ad/imgCode')}}" art="点击更换"/></li>
            ...
            <section id="footer" class="text-center">
                ...
                <ul class="footer-icons">
                    ...
                    <li><i data-am-popover="{content: '请点击图像', trigger: 'hover focus'}" title="请点击图像"
                           href="javascript:void(0)"
                           class="icon-myqq"><span class="path1"></span><span class="path2"></span></i></li>
                    <li><i title="公众号：肺笛feidi" href="javascript:void(0)" class="icon-wechats"><span
                                    class="path1"></span><span
                                    class="path2"></span><span class="path3"></span><span class="path4"></span><img
                                    src="{{asset('assets/common/images/code.png')}}"></i></li>
                </ul>
            ...
            <script src="{{asset('assets/common/js/lib/jquery.min.js')}}"></script>
            <script src="{{asset('assets/common/js/lib/modernizr-2.6.2.min.js')}}"></script>
            <script src="{{asset('assets/common/js/lib/amazeui.js')}}"></script>
            <script src="{{asset('assets/common/js/common/common.js')}}"></script>
</body>
</html>